...
class ExtractData(object):
    ...
    def Read_csv(self, file):
        ...
        kept_values2 = [['Chemical Name2', 'Average Ret. Time2', 'Maximum Area2']]
        for row in csvreader:
            sublist = []
            sublist2 = []
            sublist.append(row[0])
            sublist2.append(row[0])
            ...
            sublist2.append(max(areas))
            kept_values.append(sublist)
            kept_values2.append(sublist2)
